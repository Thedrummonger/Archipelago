...
- **[The YARG Archipelago Plugin](https://github.com/Thedrummonger/YargArchipelagoPlugin)**  
...
3. **Install the YARG Nightly Build**  
   - Open the YARC Launcher and install YARG Nightly.

4. **Install BepInEx**  
   - Locate your YARG installation folder:  
     - In the YARC Launcher, click on your YARG Nightly install.  
...
5. **Launch YARG Nightly & Import Songs**  
